  ...
  return (
    <div className="py-8 sm:py-12">
      <div className="text-center mb-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">Get in Touch</h1>
        <p className="text-lg text-purple-300">Let's create something amazing together</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Contact Information */}
        <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 sm:p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-300">St. George, Utah</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
